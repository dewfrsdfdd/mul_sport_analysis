#ifndef _MS_SPORT_CATEGORY_T9_H
#define _MS_SPORT_CATEGORY_T9_H
 ...
 * @brief: 户外跑步类
 */
extern const ms_common_sport_config_v1_t g_outside_run_category_config;

#endif /* _MS_SPORT_CATEGORY_T8_H */
